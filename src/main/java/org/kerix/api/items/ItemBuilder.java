...
public class ItemBuilder {
    ...
    private static Multimap<Attribute, AttributeModifier> getItemAttributes(ItemStack item){
        ...
        speed = switch (item.getType()){
            case WOODEN_AXE, STONE_AXE -> new AttributeModifier(UUID.randomUUID(), "generic.speed", -3.2, AttributeModifier.Operation.ADD_NUMBER, eq);
            case WOODEN_SWORD, GOLDEN_SWORD, NETHERITE_SWORD, DIAMOND_SWORD, IRON_SWORD, STONE_SWORD -> new AttributeModifier(UUID.randomUUID(), "generic.speed", -2.4, AttributeModifier.Operation.ADD_NUMBER, eq);
            case WOODEN_SHOVEL, GOLDEN_SHOVEL, NETHERITE_SHOVEL, NETHERITE_AXE, DIAMOND_SHOVEL, DIAMOND_AXE, IRON_SHOVEL, GOLDEN_AXE, WOODEN_HOE, GOLDEN_HOE, STONE_SHOVEL -> new AttributeModifier(UUID.randomUUID(), "generic.speed", -3, AttributeModifier.Operation.ADD_NUMBER, eq);
            case WOODEN_PICKAXE, GOLDEN_PICKAXE, NETHERITE_PICKAXE, DIAMOND_PICKAXE, IRON_PICKAXE, STONE_PICKAXE -> new AttributeModifier(UUID.randomUUID(), "generic.speed", -2.8, AttributeModifier.Operation.ADD_NUMBER, eq);
            case STONE_HOE -> new AttributeModifier(UUID.randomUUID(), "generic.speed", -2, AttributeModifier.Operation.ADD_NUMBER, eq);
            case IRON_AXE -> new AttributeModifier(UUID.randomUUID(), "generic.speed", -3.1, AttributeModifier.Operation.ADD_NUMBER, eq);
            case IRON_HOE -> new AttributeModifier(UUID.randomUUID(), "generic.speed", -1, AttributeModifier.Operation.ADD_NUMBER, eq);
            default -> new AttributeModifier(UUID.randomUUID(), "generic.speed", 0, AttributeModifier.Operation.ADD_NUMBER, eq);
        };

        damage = switch (item.getType()){
            case WOODEN_AXE, DIAMOND_SWORD, GOLDEN_AXE -> new AttributeModifier(UUID.randomUUID(), "generic.attack", 7, AttributeModifier.Operation.ADD_NUMBER, eq);
            case WOODEN_SWORD, GOLDEN_SWORD, IRON_PICKAXE -> new AttributeModifier(UUID.randomUUID(), "generic.attack", 4, AttributeModifier.Operation.ADD_NUMBER, eq);
            case WOODEN_SHOVEL, GOLDEN_SHOVEL -> new AttributeModifier(UUID.randomUUID(), "generic.attack", 2.5, AttributeModifier.Operation.ADD_NUMBER, eq);
            case WOODEN_HOE , GOLDEN_HOE, DIAMOND_HOE, NETHERITE_HOE, IRON_HOE, STONE_HOE -> new AttributeModifier(UUID.randomUUID(), "generic.attack", 1, AttributeModifier.Operation.ADD_NUMBER, eq);
            case WOODEN_PICKAXE, GOLDEN_PICKAXE -> new AttributeModifier(UUID.randomUUID(), "generic.attack", 2, AttributeModifier.Operation.ADD_NUMBER, eq);
            case STONE_AXE, DIAMOND_AXE, IRON_AXE -> new AttributeModifier(UUID.randomUUID(), "generic.attack", 9, AttributeModifier.Operation.ADD_NUMBER, eq);
            case STONE_SWORD, DIAMOND_PICKAXE -> new AttributeModifier(UUID.randomUUID(), "generic.attack", 5, AttributeModifier.Operation.ADD_NUMBER, eq);
            case STONE_SHOVEL-> new AttributeModifier(UUID.randomUUID(), "generic.attack", 3.5, AttributeModifier.Operation.ADD_NUMBER, eq);
            case STONE_PICKAXE -> new AttributeModifier(UUID.randomUUID(), "generic.attack", 3, AttributeModifier.Operation.ADD_NUMBER, eq);
            case IRON_SWORD, NETHERITE_PICKAXE -> new AttributeModifier(UUID.randomUUID(), "generic.attack", 6, AttributeModifier.Operation.ADD_NUMBER, eq);
            case IRON_SHOVEL -> new AttributeModifier(UUID.randomUUID(), "generic.attack", 4.5, AttributeModifier.Operation.ADD_NUMBER, eq);
            case DIAMOND_SHOVEL -> new AttributeModifier(UUID.randomUUID(), "generic.attack", 5.5, AttributeModifier.Operation.ADD_NUMBER, eq);
            case NETHERITE_AXE -> new AttributeModifier(UUID.randomUUID(), "generic.attack", 10, AttributeModifier.Operation.ADD_NUMBER, eq);
            case NETHERITE_SWORD -> new AttributeModifier(UUID.randomUUID(), "generic.attack", 8, AttributeModifier.Operation.ADD_NUMBER, eq);
            case NETHERITE_SHOVEL -> new AttributeModifier(UUID.randomUUID(), "generic.attack", 6.5, AttributeModifier.Operation.ADD_NUMBER, eq);
            default -> new AttributeModifier(UUID.randomUUID(), "generic.attack", 0, AttributeModifier.Operation.ADD_NUMBER, eq);
        };
