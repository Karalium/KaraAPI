package org.kerix.api.console.startapi;
...
public class DebugMessageAPI {
    ...
    public void StatutPlugin(StatutMessageList args, @Nullable PluginDescriptionFile description, @Nullable Logger logger) {
        if (args != null && description != null && logger != null) {
            String statut = "";
            String statutColor = ConsoleColor.RESET;
    ...
    private void logStatus(Logger logger, String pluginName, String version, String author, String status, String statusColor) {
    ...
    private void logFileStatus(Logger logger, String pluginName, String author, File file) {
        ...
        if (file.exists()) {
            ...
            logger.info(ConsoleColor.LIGHT_PURPLE +
                    "Fichier " + numberFiles + ": " + ConsoleColor.AQUA + nameFile +
                    ConsoleColor.LIGHT_PURPLE + " Initialized" + ConsoleColor.RESET + "\n" +
                    "[" + timestamp + " INFO]: " + "[-+" + tiret + "+-] " + ConsoleColor.LIGHT_PURPLE +
                    "Chemin du fichier: " + ConsoleColor.AQUA + pathFile + ConsoleColor.RESET);
